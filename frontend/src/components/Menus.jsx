...
<div className="flex gap-0 overflow-x-auto scroll-smooth mt-3">
  {groups.map((g, index) => {
    ...
    return (
      <div
        ...
        className={`min-w-[150px] cursor-pointer transition-transform duration-200 py-5 relative ${
          isSelected ? "translate-y-[-5px]" : ""
        }`}
        style={{
          left: `${index * -25}px`, // Décalage de 25px vers la gauche pour superposer les cartes
        }}
      >
        {/* VRAIE CARTE */}

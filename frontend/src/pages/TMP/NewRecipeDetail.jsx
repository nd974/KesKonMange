...
<div className="px-4 py-8 md:px-8 lg:px-16">
  <div className="flex flex-col lg:flex-row gap-6">
    ...
    {/* Bloc principal : image + titre + étoiles */}
    <div className="flex flex-row w-full lg:w-2/3 gap-6">
      {/* Image */}
      ...
      {/* Titre + étoiles */}
      <div className="-ml-10 sm:-ml-20 z-10 flex flex-col justify-top sm:py-5 py-3 w-full">
        <h1
    ...
    <div className="flex flex-col lg:w-1/3 gap-4">
      ...
      {/* Ingrédients */}
      <div className="bg-pink-100 p-4 rounded flex flex-col h-[35vh] overflow-y-auto">
      ...
      {/* Ustensiles */}
      <div className="bg-amber-100 p-4 rounded flex flex-col h-[35vh] overflow-y-auto">

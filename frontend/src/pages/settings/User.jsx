  ...
  const link = Account_links.find(
    ...
    useEffect(() => {
      const fetchData = async () => {
        ...
        if (profileId) {
            await fetch(`${API_URL}/home/get/${profileId}`)
                .then((res) => res.json())
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex gap-10">
        ...
        <main className="flex-1">
            ...
            <div className="relative w-24 h-24 rounded overflow-hidden">
                ...
                <button className="absolute inset-0 bg-black/40 flex items-center justify-center text-white text-xl">
                ✎
                </button>
            </div>
            ...
            <div className="border rounded px-4 py-3 flex justify-between items-center cursor-pointer hover:bg-gray-50">
                ...
                <span className="text-sm text-gray-700">
                    nicolas974dolphin@gmail.com [TODO ajouter home_id a Profile]
                </span>
                </div>
            ...
            <button className="px-6 py-2 rounded border font-medium">
                Annuler
            </button>
            </div>
            </div>
